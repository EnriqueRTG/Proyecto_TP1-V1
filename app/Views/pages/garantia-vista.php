<div class="card1 container-fluid">
    <h5 class="card-title text-uppercase texto">Garantía</h5>
</div>

<section class="container card m-auto mt-3" id="garantia">
    ...
    <div class="text-justify mx-4">
        ...
        <ul class="lista-no-ordenada-garantia">
            <li>
        ...
        <p>
            Según lo indique el servicio de POSTVENTA, el producto deberá ser presentado por el cliente en el local comercial de Tattoo Supply Store, sito en la calle … o
