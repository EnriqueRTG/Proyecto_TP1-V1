    ...
    <div class="row">
        ...
        <div class="row justify-content-between">
            <div class="col-12 col-sm-12 col-md-5">
                <h5 class="fw-bold justificado englobar beige">
                ...
                <div class=" aliniar ">
                    ...
                    <h6 class="justificado beige">
                        <span class="fw-bold">Titular de la empresa: César Augusto Schaffer Alippi.</span>
                    </h6>
                    <hr class="mb-4 justificado beige">
                    <!--Datos de ubicación -->
                    <h6 class="justificado beige">
                    ...
                    <div>
                        <p class="fw-bold justificado englobar beige">
                            <!-- Ubicación -->
            ...
            <div class="col-12 col-sm-12 col-md-6">
                ...
                <h5 class="text-center fw-bold englobar beige">
                ...
                <div class="container mb-4">
                    <div class="row">
                        ...
                        <form method="POST" action="<?php echo base_url(route_to("consulta")) ?>">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <label for="con_Asunto" class="form-label mb-2 englobar beige">
                                    ...
                                    <input type="text" name="con_Asunto" class="form-control" id="con_Asunto" placeholder="Ingresar Asunto">
                                ...
                                <div class="form-group">
                                    <label for="con_Mensaje" class="form-label mb-2 englobar beige">
                                    ...
                                    <textarea class="form-control" name="con_Mensaje" id="con_Mensaje" rows="3"></textarea>
                                ...
                                <button type="submit" class="btn btn-outline-warning btn-lg mt-4 px-2">Enviar</button>
                            </fieldset>
                        </form>
                        ...
                        <form method="POST" action="<?php echo base_url(route_to("contacto_C")) ?>">
                            <fieldset>
                                <div class="form-group">
                                    <label for="cont_Email" class="form-label beige">
                                        <svg width="24" height="24" fill="currentColor" class="bi bi-envelope-at" viewBox="0 0 20 20">
...
<section class="container">
    <h5 class="text-uppercase mb-4 mt-4 fw-bold justificado beige">
    ...
    <div class="embed-responsive embed-responsive-16by9 shadow p-3 mb-5 bg-white rounded">
        <iframe 
            ...
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1033.9722612346497!2d-58.798915520295445!3d-27.47740540088523!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94456b0ef159ec53%3A0xd591b6c4af519ae1!2sRio%20Juramento%201233%2C%20W3402%20Corrientes!5e0!3m2!1ses-419!2sar!4v1670278309615!5m2!1ses-419!2sar"></iframe>
    </div>
</section>